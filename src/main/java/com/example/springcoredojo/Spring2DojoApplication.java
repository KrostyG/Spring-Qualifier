...
public class Spring2DojoApplication {
	...
	public CommandLineRunner commandLineRunner(ApplicationContext ctx) {
		return args -> {
			VehiculoService vehiculoService = ctx.getBean(VehiculoService.class);
			System.out.println(vehiculoService.getClass().getName()+vehiculoService.getVehiculo().cantidadRuedas());
		};
